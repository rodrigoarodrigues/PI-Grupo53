...
function calculateExpectedReturnDate(startDate, rentalType, days) {
...
export async function createRent(rent) {
    try {
        ...
        const basePrice = parseFloat(gameData.basePrice || "10.00");
        ...
        if (isAdmin) {
            ...
            if (validatedRent.rentalType === "assinatura") {
                ...
                else if (subscriptionLimit === 1) {
                    // Assinatura Unitária: sempre cobra o preço do jogo
                    price = gamePrice;
                }
                else {
                    // Outros limites: cobrar o preço do jogo
                    price = gamePrice;
                }
            }
            else {
                // ALUGUEL UNITÁRIO: sempre cobra o preço do jogo
                price = gamePrice;
            }
        }
        else {
            ...
            if (validatedRent.rentalType === "assinatura") {
                if (subscriptionLimit === 3 && currentRentsCount < 3) {
                    ...
                    // Assinatura Full: após 3 jogos, cobra como unitário
                    ...
                    // Assinatura Unitária: preço fixo da assinatura
                    price = calculateRentalPrice({
                ...
                // Aluguel unitário: calcular baseado em dias
                price = calculateRentalPrice({
